...
def calibration():
    ...
    criteria = (cv2.TERM_CRITERIA_EPS + cv2.TERM_CRITERIA_M/Users/locke/Google Drive/UNI_MASTER/Semester4/interactive_systems/isy-02/02_features.pyAX_ITER, 30, 0.001)
