# Diese Code beinhaltet Aufgabe 4 vom Übungsblatt 2
...
def compute_simple_hog(img_color, keypoints):
...
imgDir = "resources/images/hog_test/"
images = glob.glob(imgDir+'*.jpg')
print(images)
for pic in images:
    print("for img: ", pic)
    img = cv2.imread(pic)
    descriptor = compute_simple_hog(img, keypoints)
    print(descriptor)