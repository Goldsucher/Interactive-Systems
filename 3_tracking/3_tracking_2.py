...
results = []
todo = [
    ['./images/Lenna_LAB.png', 3, 'clustering'],
    ['./images/Lenna_LAB.png', 6, 'clustering'],
    ['./images/Lenna_HSV.png', 3, 'clustering'],
    ['./images/Lenna_HSV.png', 6, 'clustering'],
    ['./images/Lenna_RGB.png', 3, 'clustering'],
    ['./images/Lenna_RGB.png', 6, 'clustering'],
    ['./images/Lenna_RGB.png', 0, 'quantization'],
    ['./images/Lenna_RGB.png', 4, 'quantization'],
    ['./images/Lenna_RGB.png', 16, 'quantization'],
    ['./images/Lenna_RGB.png', 32, 'quantization'],
    ['./images/Lenna_RGB.png', 64, 'quantization']
]
for img in todo:
