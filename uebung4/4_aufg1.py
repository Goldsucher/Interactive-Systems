# Diese Code beinhaltet Aufgabe 1 vom Übungsblatt 4
...
for label_int, label_annotations in labels.items():
    imgs_paths = glob.glob('resources/images/db/train/'+label_annotations+'/*.jpg')
...
test_images = glob.glob('resources/images/db/test/*.jpg')
