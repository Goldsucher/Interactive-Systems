# Diese Code beinhaltet Aufgabe 2 vom Übungsblatt 4
...
X_train, y_train = mnist_reader.load_mnist('resources/zalando', kind='train')
X_test, y_test = mnist_reader.load_mnist('resources/zalando', kind='t10k')
